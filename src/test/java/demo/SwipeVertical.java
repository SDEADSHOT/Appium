...
public class SwipeVertical {
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		 ...
		 * 
		 * URL url = new URL("http://localhost:4723"); AndroidDriver driver = new
		 * AndroidDriver(url, dc); JavascriptExecutor jse = (JavascriptExecutor) driver;
		 * Actions act = new Actions(driver); TouchAction action = new
		 * TouchAction(driver);
		 * 
		 * WebElement views = driver.findElement(AppiumBy.accessibilityId("Views"));
		 * jse.executeScript("mobile:clickGesture", ImmutableMap.of("elementId",
		 * (((RemoteWebElement) views).getId())));
		 */
		 ...
		 * xpath("//android.widget.TextView[@text='United States/English']")).click();
		 * driver.findElement(By.xpath("//android.widget.Button[@text='NO THANKS']")).
		 * click();
		 */
		jse.executeScript("mobile:swipeGesture",
				ImmutableMap.of("left", 689, "top", 2704, "height", 1000, "width", 0, "direction", "up", "percent", 1));
