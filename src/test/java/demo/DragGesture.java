...
public class DragGesture {
	public static void main(String[] args) throws MalformedURLException {
		...
		driver.findElement(By.xpath("//android.widget.TextView[@text='FILTER & SORT']")).click();
		WebElement src_slider = driver.findElement(By.xpath("//android.widget.SeekBar[@text='12.99']"));
		
		jse.executeScript("mobile:dragGesture", ImmutableMap.of("elementId",((RemoteWebElement)src_slider).getId(), "endX", 620 ,"endY", 922));
	}
}
